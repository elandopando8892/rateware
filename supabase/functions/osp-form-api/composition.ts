...
export function createFormApiRuntime(options: { env: Environment; fetch: typeof globalThis.fetch; postgresFactory?: PostgresFactory; clock?: () => number }) {
  ...
  return createFormApiHandler({
    ...
    canonicalFieldIds: [
          ...
          "business.principalCustomers",
          "business.employeeCount",
          "business.newlyCreated",
          "credit.requestedAmount",
          "credit.requestedTerms",
          "relationship.discoverySource",
          "finance.paymentChannel",
          "finance.paymentRequirements",
          "billing.paymentMethod",
          "billing.invoiceResponsibleName",
          "billing.invoiceResponsibleTitle",
          "billing.invoiceEmail",
          "billing.paymentComplementEmail",
          "billing.invoiceHours",
          "billing.invoiceRequirements",
          "billing.portalName",
          "billing.portalAccessInstructions",
          "billing.portalUserRequestEmail",
          "billing.portalEmail",
          "billing.invoiceSubmissionChannel",
          "billing.invoiceUploadDeadline",
          "billing.hasSpecialRequirements",
          "billing.specialRequirements",
          "procurement.purchaseOrderRequired",
          "commercial.serviceAgreementExists",
          "operations.podDelivery",
          "banking.bankName",
          ...
          "banking.branch",
          "banking.currency",
          "banking.paymentReference",
          "banking.paymentConcept",
          "collections.responsibleName",
          "collections.responsibleTitle",
          "collections.email",
          "collections.fixedPhone",
          "collections.mobile",
          "legal.representativeName",
          "legal.signerTitle",
          "compliance.securityQuestionnaireApplicability",
          "compliance.securityQuestionnaireCompleted",
          "credit.policyAccepted",
          "legal.letterUnderProtestAccepted",
          "documentation.checklistComplete"
    ],
  });
}
