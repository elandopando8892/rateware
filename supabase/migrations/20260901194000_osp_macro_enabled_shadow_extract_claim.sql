-- Extend the exact, hash-pinned shadow canary to macro-enabled customer forms.
-- The original XLSM remains immutable; the worker parses only its sanitized
-- OpenXML analysis copy. This grants no broad historical intake or outbound
-- authority.
