...
drop trigger if exists provider_service_guard_requirement_link_identity on public.provider_document_requirement_links;
create trigger provider_service_guard_requirement_link_identity
before update on public.provider_document_requirement_links
for each row execute function public.provider_service_guard_requirement_link_identity();

revoke all on function public.provider_service_guard_requirement_link_identity() from public, anon, authenticated;
