...
do $$
begin
  if to_regprocedure('public.rateware_inherit_rate_owner()') is not null then
    execute 'revoke all on function public.rateware_inherit_rate_owner()
      from public, anon, authenticated, service_role';
    execute 'comment on function public.rateware_inherit_rate_owner() is
