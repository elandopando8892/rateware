...
assert.equal(extensionIds.size, 145, 'the OSP contract must contain the reviewed 145 surfaces');
assert.equal(discovered.length, 145, 'every reviewed OSP surface must still be discoverable');
...
console.log('OSP action contract test passed: 145/145 surfaces are registered and fingerprinted.');
