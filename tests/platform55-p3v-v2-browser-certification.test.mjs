...
function captureFor({ route, state, viewport }) {
  ...
  return {
    ...
    evidence_geometry: {
      heading: { top: 20, bottom: 60, height: 40 },
      state_surface: { top: 180, bottom: 260, height: 80 },
      source_retention: { top: 80, bottom: 140, height: 60 },
...
test("state, geometry, evidence, accessibility, and read-only drift reject", () => {
  ...
  const mutations = [
    ...
    ["contradictory geometry", { evidence_geometry: { heading: { top: -500, bottom: -450, height: 50 }, state_surface: { top: 2000, bottom: 2100, height: 100 }, source_retention: { top: 1500, bottom: 1550, height: 50 }, viewport_height: base.viewport[1], scroll_y: 1000 } }],
    ["scrolled evidence", { evidence_geometry: { ...base.evidence_geometry, scroll_y: 1 } }],
