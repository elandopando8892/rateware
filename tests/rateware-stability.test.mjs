...
const publicBidInviteApiSource = rfxBidApiSource.slice(rfxBidApiSource.indexOf("async function publicBidRoomInviteRequest"), rfxBidApiSource.indexOf("Deno.serve"));
