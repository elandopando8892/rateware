...
const ledgerPath = resolve(process.env.RATEWARE_PRIVATE_RESOLVER_LEDGER_PATH || resolve(import.meta.dirname, "../.tmp/private-resolver-ledger.json"));
...
createServer(async (request, response) => {
  ...
  console.log(`Durable candidate ledger: ${ledgerPath}`);
  console.log("Candidate fixture only; canary read enabled; live submission disabled; no request body or credential material persisted.");
});
