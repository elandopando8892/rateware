...
const gmailAuthorizationFingerprints = {
  'edge.provider-gmail-intake-api.provider_gmail_status': '39bb8f3499e80926e6c257ca61d12326fd12887879b4848c7e94da69ed1e41aa',
  'edge.provider-gmail-intake-api.renew_provider_gmail_watch': '39bb8f3499e80926e6c257ca61d12326fd12887879b4848c7e94da69ed1e41aa',
  'edge.provider-gmail-intake-api.start_provider_gmail_oauth': '39bb8f3499e80926e6c257ca61d12326fd12887879b4848c7e94da69ed1e41aa',
  'edge.provider-gmail-intake-api.sync_provider_gmail_inbox': '39bb8f3499e80926e6c257ca61d12326fd12887879b4848c7e94da69ed1e41aa',
  'edge.provider-gmail-oauth-callback.complete_provider_gmail_oauth_callback': 'db30791870191bc2a4f19d7e026e8ca8c7cffb1867b781329caac896bbc496db',
  'edge.provider-gmail-push.receive_provider_gmail_push': '9724ca7358086c2fa6f177a5fef289739baa5f61b7de7d89044652f6248d6217',
};
...
const gmailSurfaces = [
  {
    ...
    sourceFingerprint: '63b12496d88ef1b16fdcb95f8fbf6c22e1fba2bb67387a8a746f64e0c39fbfc2',
    ...gmailSharedMetadata,
  },
  {
    ...
    sourceFingerprint: '7ecbce2369d1655576e65183bd812115b64f41010f50980cd3dc8e54aa55206f',
    ...gmailSharedMetadata,
  },
  {
    ...
    sourceFingerprint: 'd061938a979e251f63137052e8dad9c83da19e263fcff4cdfdbe6ddbbb43ee99',
    ...gmailSharedMetadata,
  },
  {
    ...
    sourceFingerprint: 'baa37246ca9828670bb12b436f8d0b3993d76c5fd2bcd9c0809b5b2783b6a33a',
    ...gmailSharedMetadata,
  },
  {
    ...
    sourceFingerprint: '52ccd869e182062f40eb665f255db2698cdf22c74197be0858e37c51855a063d',
    ...gmailSharedMetadata,
  },
  {
    ...
    sourceFingerprint: '817a86278c3b43ad0ce0031c3bcde4c1c830cebe3f20000f58f3c39442d50e64',
    ...gmailSharedMetadata,
  },
];
...
export const ACTION_CONTRACT = {
  ...
  contractVersion,
  methodVersion: `${BASE_ACTION_CONTRACT.methodVersion}+provider-service-convergence+provider-gmail-intake+provider-gmail-pubsub+carrier-list-templates+rfx-invitation-reviews+rfx-atomic-award+osp-customer-setup`,
  expectedCounts: {
    governable: BASE_ACTION_CONTRACT.expectedCounts.governable + delta.governable + 6 + carrierTemplateDelta.governable + rfxInvitationReviewDelta.governable + rfxAtomicAwardExtension.expectedCountsDelta.governable + ospExtension.expectedCountsDelta.governable,
    edge: BASE_ACTION_CONTRACT.expectedCounts.edge + delta.edge + 6 + carrierTemplateDelta.edge + rfxInvitationReviewDelta.edge + ospExtension.expectedCountsDelta.edge,
    postgres: BASE_ACTION_CONTRACT.expectedCounts.postgres + delta.postgres + carrierTemplateDelta.postgres + rfxAtomicAwardExtension.expectedCountsDelta.postgres + ospExtension.expectedCountsDelta.postgres,
