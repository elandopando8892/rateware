...
const FIXED_EDGE_OPERATIONS = new Map([
  ...
  ["osp-case-api", [
    ...
    ["save_package_member_review", "POST /functions/v1/osp-case-api?action=save_package_member_review", "human"],
  ...
  ["osp-form-api", [
    ...
    ["get_answer_memory_evidence", "POST /functions/v1/osp-form-api action=get_answer_memory_evidence", "human"],
    ["link_answer_memory_evidence", "POST /functions/v1/osp-form-api action=link_answer_memory_evidence", "human"],
