...
export const BULK_IMPORT_TEMPLATE_COLUMNS = [
  ...
  { key: "origin_zip_prefix", header: "Origin ZIP", required: "optional", example: "500", notes: "US/CA ZIP prefix or Mexican postal prefix when already known." },
  { key: "origin_state", header: "Origin State", required: "optional", example: "EM", notes: "State or province code. Mexico state codes are treated as Mexican when paired with MX context." },
  { key: "origin_country", header: "Origin Country", required: "optional", example: "MX", notes: "Use MX, US, or CA when available to avoid country ambiguity." },
  { key: "origin_market", header: "Origin Key Market Area", required: "optional", example: "Toluca Market", notes: "Rateware key market area or metro market." },
  { key: "origin_region", header: "Origin Region", required: "optional", example: "Central Mexico", notes: "Rateware region." },
  { key: "destination", header: "Destination", required: "yes", example: "Canton, MS", notes: "City, state and ZIP if available." },
  { key: "destination_zip_prefix", header: "Destination ZIP", required: "optional", example: "390", notes: "US/CA ZIP prefix or Mexican postal prefix when already known." },
  { key: "destination_state", header: "Destination State", required: "optional", example: "MS", notes: "State or province code." },
  { key: "destination_country", header: "Destination Country", required: "optional", example: "US", notes: "Use MX, US, or CA when available." },
  { key: "destination_market", header: "Destination Key Market Area", required: "optional", example: "Jackson Mkt (MS)", notes: "Rateware key market area or metro market." },
  { key: "destination_region", header: "Destination Region", required: "optional", example: "Southeast", notes: "Rateware region." },
...
const exampleRows = [
  {
    ...
    origin: "Lerma, EM",
    origin_zip_prefix: "500",
    origin_state: "EM",
    origin_country: "MX",
    origin_market: "Toluca Market",
    origin_region: "Central Mexico",
    destination: "Canton, MS",
    destination_zip_prefix: "390",
    destination_state: "MS",
    destination_country: "US",
    destination_market: "Jackson Mkt (MS)",
  ...
  },
  {
    ...
    origin: "Apodaca, NL",
    origin_zip_prefix: "640",
    origin_state: "NL",
    origin_country: "MX",
    origin_market: "Monterrey Market",
    origin_region: "Northeast Mexico",
    destination: "Dallas, TX",
    destination_zip_prefix: "750",
    destination_state: "TX",
    destination_country: "US",
    destination_market: "Dallas Mkt (TX)",
...
export async function downloadBulkImportTemplate() {
  ...
  const instructionRows = [
    ...
    ["Origin/Destination ZIP, State, Country, Key Market Area, and Region are optional but will be preserved when supplied."],
    ["For Mexico, market/region should come from the Mexico metro catalog. Do not force Mexican cities into US/CA 3-digit ZIP market logic."],
