...
const TEMPLATE_FIELD_ALIASES = {
  vendor_name: ["vendor", "vendor name", "carrier", "carrier name", "supplier", "transportista", "proveedor", "legal name", "commercial name", "nombre comercial", "razon social"],
  ...
  origin_zip_prefix: ["origin zip", "origin zip code", "origin postal code", "origin postal", "orig zip", "orig zip code", "o zip", "o zip/st", "o postal", "or zip", "pickup zip", "pickup postal code", "zip origen", "codigo postal origen", "cp origen"],
  origin_state: ["origin state", "origin st", "orig state", "orig st", "o state", "o st", "or state", "or st", "estado origen", "origin province", "origin prov"],
  origin_country: ["origin country", "orig country", "o country", "or country", "pais origen", "country origin"],
  origin_market: ["origin market", "origin key market area", "origin kma", "origin market area", "origin metro", "origin metro city", "orig market", "o market", "o kma", "or market", "kma origin", "market origin", "mercado origen"],
  origin_region: ["origin region", "orig region", "o region", "or region", "region origin", "region origen"],
  destination: ["destination", "destino", "to", "dest", "delivery", "consignee", "destination city", "dest city"],
  destination_zip_prefix: ["destination zip", "destination zip code", "destination postal code", "destination postal", "dest zip", "dest zip code", "d zip", "d zip/st", "d postal", "delivery zip", "delivery postal code", "zip destino", "codigo postal destino", "cp destino"],
  destination_state: ["destination state", "destination st", "dest state", "dest st", "d state", "d st", "estado destino", "destination province", "destination prov"],
  destination_country: ["destination country", "dest country", "d country", "pais destino", "country destination"],
  destination_market: ["destination market", "destination key market area", "destination kma", "destination market area", "destination metro", "destination metro city", "dest market", "d market", "d kma", "kma destination", "market destination", "mercado destino"],
  destination_region: ["destination region", "dest region", "d region", "region destination", "region destino"],
